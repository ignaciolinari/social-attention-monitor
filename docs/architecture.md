...
- **Multipage Navigation**: Sidebar-driven navigation across 17 pages, including Executive Overview (landing), Compare Titles, Box Office (with correlation coefficients), Language Segmentation, Historical Benchmark, and Watchlists. CSV export available on Trending and Compare tables.
